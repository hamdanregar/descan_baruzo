                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center gap-3 mb-5">
                            ...
                            <div>
                                <div className="font-bold text-white text-lg">Desa Baruzo</div>
                                <div className="text-gray-400 text-xs"></div>
                            </div>
                        </div>
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Sistem informasi terpadu untuk kemajuan desa dan pelayanan masyarakat yang efisien, efektif dan transparan.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <span className="text-gray-400 text-sm">info@desabaruzo.id</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="border-t border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
                    <p className="text-gray-500 text-sm">
                        © {currentYear} Portal Desa Baruzo. All rights reserved.
                    </p>
